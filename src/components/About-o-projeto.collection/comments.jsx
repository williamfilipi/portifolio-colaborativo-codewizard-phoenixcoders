...
function Comments() {
  return (
	  <>
			...
			<section className="flex flex-nowrap font-custom-inconsolata sm:flex sm:flex-wrap sm:m-4">
					<div className="bg-dark-color-secondary lg:shadow rounded-lg p-4 m-3">
						<Images/>
						...
						<div className="flex items-center sm:flex sm:flex-wrap">
						...
						<div className="flex justify-center m-2 text-lg font-custom-inconsolata sm:m-6">
							<h3>Deixe O Seu Comentário</h3>
						</div>

						<div className="m-2 flex justify-center font-custom-inconsolata">
							 <form className="sm:grid sm:place-items-rigth">
							 ...
							 <div className="bg-dark-color-secondary rounded-lg p-4 m-3 w-4/12 sm:hidden">
									<p>"Vejo um potencial incrível no 'Frontend Fusion'. A colaboração é a essência do avanço tecnológico, e vocês capturaram isso de forma brilhante. Achei inspirador. Recomendo focar na escalabilidade do projeto para garantir que a estrutura possa crescer sem comprometer a qualidade."</p>
...
export function Button(){
	return(
	    ...
	    <button class="relative inline-flex p-0.5 ml-24 text-sm text-gray-900 rounded-lg group bg-button-primary to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 sm:grid">
